...
var _core4 = require("@loaders.gl/core");
  ...
  (0, _createClass2["default"])(Tile3DLayer, [{
    ...
    value: function initializeState() {
      if ('onTileLoadFail' in this.props) {
        _core3.log.removed('onTileLoadFail', 'onTileError')();
      }
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                _context.next = 9;
                return (0, _core4.load)(tilesetUrl, loader, options);
    ...
    value: function _createPointCloudTileLayer(tileHeader) {
      ...
      return new SubLayerClass({
        ...
        coordinateSystem: _core3.COORDINATE_SYSTEM.METER_OFFSETS,
    ...
    value: function _createSimpleMeshLayer(tileHeader) {
      ...
      var geometry = new _core2.Geometry({
        drawMode: 4,
        attributes: {
          positions: positions,
          normals: normals,
