...
import { pixelsToWorld, getViewMatrix, addMetersToLngLat, getProjectionParameters, fitBounds } from '@math.gl/web-mercator';
  ...
  get subViewports() {
    if (this._subViewports && !this._subViewports.length) {
      ...
      for (let x = minOffset; x <= maxOffset; x++) {
        const offsetViewport = x ? new WebMercatorViewport(_objectSpread({}, this, {
          worldOffset: x
        })) : this;
